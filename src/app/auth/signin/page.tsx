      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-6 sm:mb-8">
          <div className="flex items-center justify-center gap-2 mb-4">
            <Scale className="h-8 w-8 sm:h-10 sm:w-10 text-blue-600" />
            <span className="text-2xl sm:text-3xl font-bold text-gray-900">LegalLens AI</span>
          </div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Welcome Back</h1>
          <p className="text-sm sm:text-base text-gray-600">Sign in to analyze your legal documents</p>
        </div>
